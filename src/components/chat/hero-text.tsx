...
export function HeroText({ name }: { name: string }) {
  return (
    <div className="h-screen flex flex-col items-center justify-center text-center font-[family-name:var(--font-raleway)]">
      ...
      {/* Credits line */}
      <div className="mt-12 flex items-center gap-3 text-xs text-muted-foreground/35">
        <a
          href="https://github.com/LikeDreamwalker/previously"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 hover:text-muted-foreground/55 transition-colors"
        >
        ...
        <Link
          href="/docs"
          className="hover:text-muted-foreground/55 transition-colors"
        >
          Docs
        </Link>
      </div>
